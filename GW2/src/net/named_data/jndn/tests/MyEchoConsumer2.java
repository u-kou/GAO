...
class Counter3 implements OnData, OnTimeout {
  public void
...
public class MyEchoConsumer2 {
  public static void
  main(String[] args)
  {
    try {
    	Runtime runtime = Runtime.getRuntime();
    	String prefix = "/testecho";
    	String remoteURI = "192.168.2.103";
    	
    	try {
            runtime.exec("nfdc register " + prefix + " udp://" + remoteURI); 
        } catch (IOException e) {
            e.printStackTrace();
        }
