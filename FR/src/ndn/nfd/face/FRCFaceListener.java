...
public class FRCFaceListener implements OnInterestCallback, OnRegisterFailed, OnRegisterSuccess {
	  
	 public FRCFaceListener(Face face, Name KeyPrefix){
		 try{
       ...
       InterestFilter filter)
    {
      ...
      if(message.getName().contains("RMICN")) //Interest: /RMICN/FR0/GWXService
    	  message.setName("/RMICN/" + message.getName().substring(11));
      
      Packet packet = new Packet(face.getRemoteURI(), 
    		  face.getInterface().getInterfaceURI(), message);
      face.receive(packet);
