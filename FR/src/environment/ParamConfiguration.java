...
public class ParamConfiguration {
	...
	public static final String[] DCPCommand = 
		{"/home/pi/FR/FRControlScript.py", "-c","udp:0.0.0.0:14550","-f","FNPathRun"};
	
	//public static final String[] DCPCommand = 
		//{"/home/u-kou/eclipse-workspace/FRControlScript.py", "-c","tcp:127.0.0.1:5760","-f","FNPathRun"};
	
	//経路を書き込むファイルのアドレス
	public static final String PathFileAddress = "/home/pi/FR/path.txt";
	//public static final String PathFileAddress = "/home/u-kou/eclipse-workspace/path.txt";
	
	public static final String NowLocationFileAddress = "/home/pi/FR/NowLocation.txt";
	//public static final String NowLocationFileAddress = "/home/u-kou/eclipse-workspace/NowLocation.txt";
